...
def player_string(choice):
    if choice.lower() == 'rock' or choice.lower() == '1':
        ...
        return 'Spock' , 3
    elif choice.lower() == 'zombie' or choice.lower() == '5':
        return 'Zombie' , 4
    elif choice.lower() == 'gun' or choice.lower() == '6':
        return 'Gun' , 5
    elif choice.lower() == 'lizard' or choice.lower() == '7':
        return 'Lizard' , 6
...
def check(player,jarvis):
    ...
    if player == jarvis:
        print('Both ties!')
        return score
    elif player == 0 and jarvis == 3: # rock vs spock
        print('Computer wins!')
        return (score-1)
    elif player == 4 and jarvis == 0: # zombie vs rock
        print('Computer wins!')
        return (score-1)
    elif player == 1 and jarvis == 4: # paper vs zombie
        print('Computer wins!')
        return (score-1)
    elif player == 3 and jarvis == 4: # spock vs zombie
        print('Computer wins!')
        return (score-1)
    elif player == 2 and jarvis == 5: # scissors vs gun
        print('Computer wins!')
        return (score-1)
    elif player == 0 and jarvis == 5: # rock vs gun
        print('Computer wins!')
        return (score-1)
...
while replay.lower() != 'n':
    ...
    while count < 3:
        choice = ''
        while choice.lower() != 'rock' or  choice.lower() != 'paper' or choice.lower() != 'scissors' or choice.lower() != 'spock' or choice.lower() != 'zombie'  or choice.lower() != 'gun' or choice.lower() != 'lizard' or choice.lower() != '1' or choice.lower() != '2' or choice.lower() != '3' or choice.lower() != '4' or choice.lower() != '5' or choice.lower() != '6' or choice.lower() != '7' :
            try:
