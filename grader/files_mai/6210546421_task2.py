...
def game_decision(player_choice_num, computer_choice_num):
    ...
    if player_choice_num == computer_choice_num:
        print("Both ties!")
    elif ((player_choice_num + 1) % 5) == computer_choice_num or (
            ((player_choice_num + 1) % 5) + 2) == computer_choice_num:
        print("Computer wins!")
    else:
        print("Player wins!")
