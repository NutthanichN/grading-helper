def check_valid_input(s):
    ...
    True
    >>> check_valid_input("pitchapageta")
    False
    """
    if s == "rock":
        return True
...
def game_decision(player_choice_num, computer_choice_num):
    ...
    if player_choice_num == computer_choice_num:
        print("Both ties!")
    elif ((player_choice_num + 1) % 7) == computer_choice_num or (
            ((player_choice_num + 3) % 7)) == computer_choice_num or (
            ((player_choice_num + 5) % 7)) == computer_choice_num:
        print("Computer wins!")
    else:
        print("Player wins!")
